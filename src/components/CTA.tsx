    ...
    <section className="py-20 md:py-32 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <Button
            size="lg"
            className="bg-secondary hover:bg-secondary/90 text-white font-montserrat font-bold text-lg px-12 py-6 shadow-2xl animate-scale-in"
          >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-16">
          ...
          <div className="text-center text-white animate-fade-in-up" style={{ animationDelay: "150ms" }}>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm mb-4">
              <MapPin size={28} />
            </div>
            <h3 className="font-montserrat font-bold text-lg mb-2">
          ...
          <div className="text-center text-white animate-fade-in-up" style={{ animationDelay: "300ms" }}>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm mb-4">
              <Phone size={28} />
            </div>
            <h3 className="font-montserrat font-bold text-lg mb-2">
