      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button
              variant="outline"
              className="font-montserrat font-semibold border-2 transform-gpu transition-transform duration-200 ease-out hover:-translate-y-1 hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-primary/25"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 animate-fade-in ">
            ...
            <Button
              variant="outline"
              className="w-full mt-2 font-montserrat font-semibold border-2 transform-gpu transition-transform duration-200 ease-out hover:-translate-y-1 hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-primary/25"
              onClick={handleQRClick}
            >
              <QrCode className="mr-2 h-4 w-4" />
              Generar QR
