    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <a href="#inicio" className="flex items-center gap-3 animate-fade-in">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button className="bg-primary hover:bg-primary/90 font-montserrat font-semibold">
              Reservar
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 animate-fade-in">
            ...
            <Button className="w-full mt-4 bg-primary hover:bg-primary/90 font-montserrat font-semibold">
              Reservar
            </Button>
          </div>
        )}
